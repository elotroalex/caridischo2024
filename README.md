...
<code>{% raw %}
{% include collection_gallery.html collection='caridischo'
...
<code>{% raw %}{% include collection_gallery.html collection='caridischo' facet_by='object_type' only='portrait' num_column=4 %}{% endraw %}</code>
