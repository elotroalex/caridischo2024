...
`{% raw %}{% include gallery.html collection='caridischo' facet_by='object_type|location|tags*' num_column=4 %}{% endraw %}`
...
`{% raw %}{% include gallery.html collection='caridischo' field='object_type' value='portrait' num_column=4 %}{% endraw %}`
...
`{% raw %}{% include gallery.html collection='caridischo' field='object_type' value='manuscript' facet_by='location|current_location' num_column=4 %}{% endraw %}`
...
\\
`{% raw %}{% include gallery.html collection='caridischo' facet_by='object_type' num_column=4 %}{% endraw %}`
